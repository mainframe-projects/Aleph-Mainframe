...
-INC   ICDK3200                                                         
      ...
      *----------------------------------------------------------------*
                   ...
                   AND S3200-SAID-CD-EST-ACLT EQUAL SPACES              
      *                [L]CR nao atualizada                             
                       MOVE 'A' TO S3200-SAID-CD-EST-ACLT               
                   END-IF                                               
                   IF  S0100-ASS-INVD                                   
                   AND S3200-SAID-CD-EST-ACLT EQUAL SPACES              
      ...
      *                                                                 
           ...
           END-EXEC.                                                    
      *                                                                 
      *  [FIXME JC - RETIRAR MOVIMENTAÇ O ]                             
           MOVE 0 TO GDA-RESP                                           
           MOVE 0 TO KRTN-CD-RTN OF ICDS7100-DADOS                      
      *  [END-FIXME]                                                    
      *                                                                 
      ...
      *  [FIXME JC - RETIRAR MOVIMENTACAO ]                             
           MOVE 0 TO GDA-CD-RTN                                         
      *  [END FIXME]                                                    
      *                                                                 
      D    MOVE GDA-CD-RTN  TO KDPY-CD-RTN.                             
      ...
      *        Pesquisa tabela DB2ICD.IDFR_CHV_ADD_CTFR                 
               ...
               END-EXEC                                                 
      *                                                                 
      D        DISPLAY 'K002-CD-ADD-CTFR-DTTR:['K002-CD-ADD-CTFR-DTTR']'
      D        DISPLAY 'S3200-S002P SQLCODE : ' SQLCODE                 
               EVALUATE SQLCODE                                         
      *                                                                 
      *        Registro localizado                                      
                   WHEN +0                                              
      ...
      *--------------------------------------*                          
      D    DISPLAY '000 ' CTE-PRGM ' - 811000-EXECUTA-ICDS003C'         
      D                            ' - DB2ICD.CTFD_DGTL'.               
      *                                                                 
      D    DISPLAY '000 ' CTE-PRGM ' - Antes da sub-rotina ICDS003C'.   
      *                                                                 
      D    DISPLAY '000 ' CTE-PRGM                                      
      D            ' - '  CTE-VERS                                      
      D            ' - '  ICDS003C.                                     
      ...
      *                                                                 
      D    MOVE GDA-CD-RTN  TO KDPY-CD-RTN.                             
      D    DISPLAY '000 ' CTE-PRGM ' - Volta da sub-rotina ICDS003C'    
      D            ' - RETURN-CODE = ' KDPY-CD-RTN.                     
      *                                                                 
      ...
      *  [FIXME JC -RETIRAR MOVIMENTACAO]                               
           MOVE 'A'    TO KL03-CD-EST-CTFD-DGTL (1)                     
      *  [END FIXME]                                                    
      *                                                                 
      D    DISPLAY '000 ' CTE-PRGM                                      
      D             ' - ' CTE-VERS                                      
      ...
      *                                                                 
       999000-ERRO-001.                                                 
      D    DISPLAY '000 ' CTE-PRGM ' - 999000-ERRO-001.              '. 
